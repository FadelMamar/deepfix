...
def create_train_and_val_datasets(split:str="train[0:500]",
                                image_size:int=518,
                                embedding_model:Optional[FeatureExtractor]=None,
                                device:str="cpu",
                                num_workers:int=4,
                                batch_size:int=8,
                                pin_memory:bool=False)->Tuple[FoodDataset,FoodDataset]:
    if embedding_model is not None:
        dataset = FoodDatasetWithEmbeddings(split=split,image_size=image_size,embedding_model=embedding_model)
...
def load_train_and_val_datasets(image_size:int=518,
                                embedding_model:Optional[FeatureExtractor]=None,
                                device:str="cpu",
                                num_workers:int=4,
                                split_size:str=":10%",
    ...
    val_dataset = create_train_and_val_datasets(split=f'validation[{split_size}]',**cfg)
